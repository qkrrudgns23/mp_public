...
# Simulation positions JSON: compact_v2 tracks (dense t/x/y/v arrays + sparse metadata changes).
...
def _build_layout_mode_tabs_html() -> tuple[str, str]:
    primary_html = "".join(
        [
            ...
            _layout_mode_button_html("apronTaxiway", "Leadin Taxiway", "layout_mode_apron_taxiway.svg"),
